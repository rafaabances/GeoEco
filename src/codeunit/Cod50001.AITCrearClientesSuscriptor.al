codeunit 50001 "AIT Crear Clientes/Suscriptor"
{
    ...
    // procedure CrearProveedoresPorSuscriptor(Suscriptor: record "AIT Suscribers"): Code[20]
    // var
    ...
    //     vendor."AIT Customer Category" := Suscriptor."AIT Customer Category";
    //     vendor."AIT Customer Type" := Suscriptor."AIT Customer Type";
    //     vendor.Modify();
    //     exit(vendor."No.")
    // end;
}